          ...
          <div className="header-inner" style={{ position: 'relative', zIndex: 1, display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end' }}>
            <div>
              ...
              <h1 style={{ fontSize: '1.75rem', fontWeight: 700, color: 'var(--color-text-inv)', letterSpacing: '-.02em', marginBottom: 6 }}>
                目標設定シート <span style={{ fontSize: '.9rem', fontWeight: 500, marginLeft: 2, padding: '3px 12px', borderRadius: 999, background: 'rgba(206, 93, 151, 0.32)', color: 'var(--color-text-inv)', letterSpacing: '.01em', verticalAlign: 'middle' }}>2026年4月-9月期</span>
              </h1>
          ...
          >
            ...
            <div style={{ minWidth: 0 }}>
              ...
              <div className="glass-panel" style={{ marginBottom: 24 }}>
                ...
                {step === 5 && <CommitmentForm data={formData.personal} grade={formData.cover.grade} onChange={updatePersonal} />}
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <br />
        1. カバー &nbsp; 2. 会社目標 &nbsp; 3. 部署目標 &nbsp; 4. 個人目標 &nbsp; 5. ギャランティ &nbsp; 6. グレード表 &nbsp; 7. 昇格・昇給採点 &nbsp; 8. ボーナス評価採点
      </div>
    </div>
  );
}
